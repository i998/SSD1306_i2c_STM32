...
/*
This is an example for SSD1306_i2c library for STM32. Requires Adafruit_GFX Library.
SSD1306_i2c Library is in the /src folder. 
...
//local copy of the library is used for this example  
...
#error("Height incorrect, please update Adafruit_SSD1306.h!");
#endif
...
void setup()   {                
  ...
  //SSD1306_SWITCHCAPVCC: by default, we'll generate the high voltage from the 3.3v line internally! (neat!)
